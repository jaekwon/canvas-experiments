define(["dojo/on", "dojo/dom", "dojox/gfx", "dojox/color"], function(on, dom, gfx, color) {
  return {
    canvasObject: function() {
      var surface = gfx.createSurface("tutorial_div",400,400);
      return surface
    },
    clicky: function(surface) {
      var div = dom.byId("tutorial_div");
      on(div, "click", function(clickEvent) {
        var xcoord = clickEvent.offsetX;
        console.log(xcoord);
        var ycoord = clickEvent.offsetY;
        var randColor = color.toRgb();
        console.log(randColor);
        surface.createCircle({ cx: xcoord, cy: ycoord, rx:50, r:25 }).setFill(randColor);
      });
    },
...
//};
//
//var relMouseCoords = function(clickEvent){
//    var totalOffsetX = 0;
//    var totalOffsetY = 0;
//    var canvasX = 0;
//    var canvasY = 0;
//    var currentElement = canvasObject.canvas;
//
//    do {
...
//}
//
//var randomizeCoords = function(mouseCoords) {
//  var newX = (mouseCoords.x - (Math.random() * 100));
//  var newY = (mouseCoords.y + (Math.random() * 100));
//  return {x:newX, y:newY};
//};
//
//var DrawBasics = function(clickEvent) {
//  this.mouseCoords = relMouseCoords(clickEvent, this);
//  var rgb = hsv_to_rgb((this.mouseCoords.x/1000), Math.random(), 0.95);
...
//};
//
//  //var ImageStamp = function(clickEvent) {
//  //  this.drawing = canvasBasics;
//  //  this.draw = function() {
//  //    var img = new Image();
...
//  //};
//
//  //var Line = function(clickEvent) {
//  //  this.drawLine = function(color) {
//  //    var line = this;
//  //    line.downCoords = relMouseCoords(clickEvent, canvasBasics);
...
//  //      line.upCoords = relMouseCoords(upEvent, canvasBasics);
...
//  //    });
//  //    var arcBusiness = new ArcBusiness(mouseDown);
//  //    var startArc = arcBusiness.delayArc(line.downCoords, -1);
//  //  }
//  //};
//
//  //var Heart = function(clickEvent) {
//  //  this.drawing = canvasBasics;
...
//  //};
//
//  //var SquareBusiness = function(clickEvent) {
//  //  this.drawing = canvasBasics;
...
//  //};
//
//  var Skull = function(clickEvent) {
//    this.drawing = DrawBasics(clickEvent);
...
//  };
//
//  //var ArcBusiness = function(clickEvent) {
